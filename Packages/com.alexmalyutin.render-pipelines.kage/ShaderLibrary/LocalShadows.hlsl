...
half SampleLocalShadowMap3x3(float3 positionWS, uint index)
{
...
half SampleLocalShadowMap2x2(float3 positionWS, uint index)
{
...
half GetLocalShadow(float3 positionWS)
{
    ...
    return SampleLocalShadowMap3x3(positionWS, 0);
}
